...
class Result extends BaseController
{
    ...
    public function index()
    {
        ...
        $data = [
            ...
            'result_paslon' => $this->result->select('vote, COUNT(*) as jumlah')->where('vote="1"')->get(),
